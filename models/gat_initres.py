...
class GATInitResLayer(MessagePassing):
    ...
    def __init__(self, channels: int,
        ...
        self.gat_layer = GATv2Conv(in_channels=channels, out_channels=channels, concat=True)
    ...
    def forward(self, x: Tensor, x_0: Tensor, edge_index: Adj,
        ...
        t1 = torch.mul(x_gat, (1. - self.alpha))
...
class GATInitRes(GNN):
    def __init__(self, in_channels: int, out_channels: int, hidden_channels: int, n_layers: int,
        ...
        super().__init__(in_channels=in_channels, out_channels=out_channels, hidden_channels=hidden_channels,
                         n_layers=n_layers, conv_op=GATInitResLayer, conv_args={'channels': hidden_channels,
                                                                                'alpha': alpha},
                         dropout=dropout)
